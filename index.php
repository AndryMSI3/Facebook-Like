        ...
        <div id="modal-account-creation" class="modal-account-creation">
            ...
            <div class="modal-content">
                    ...
                    <form action="app/Suscribe.php" method="post" >
                                ...
                                <input class="form-field" name="identifiant" type="text" placeholder="E-mail" style="width: 100%;">
                        ...
                        <p id="error" name="error" value="<?php echo $_SESSION['error'];?>" onchange="display_block();">
